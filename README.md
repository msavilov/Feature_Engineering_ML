...
## Проекты
  ...
  [2. Loss function and optimization](#loss_function_and_optimization)
  
  [3. Metrics and Model selection](#metrics_and_model_selection)
  
  [4. Data problems](#data_problems)
  
  [5. Work with variables](#work_with_variables)
  
  [6. Decision trees](#decision_trees)
  
  [7. Work with outliers](#work_with_outliers)
